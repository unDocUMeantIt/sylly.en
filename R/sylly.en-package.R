...
#' }
#'
#' Adds support for the English language to the 'sylly' package. Due to some restrictions on
...
#'
#' @aliases sylly.en-package
#' @name sylly.en-package
#' @docType package
#' @title The sylly.en Package
